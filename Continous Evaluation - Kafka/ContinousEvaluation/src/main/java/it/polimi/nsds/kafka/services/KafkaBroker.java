...
public class KafkaBroker {
	...
	public static String brokerAddress = "localhost:9091";
	private static final String offsetResetStrategy = "earliest";
	private static final boolean autoCommit = false;
	private static final String isolationLevel = "read_committed";
	// value use to create some initial values
	...
	public static Properties getProducerProperties() {
		...
		// exactly once semantics between the producer and the partition
