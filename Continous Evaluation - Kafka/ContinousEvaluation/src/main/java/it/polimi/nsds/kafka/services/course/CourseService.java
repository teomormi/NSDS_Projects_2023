...
public class CourseService extends UnicastRemoteObject implements CourseRemote {
	...
	private static KafkaProducer<String, String> course_producer;
	...
	public static void main(String[] args) {
		...
		course_producer = KafkaBroker.getProducerTransactional();
		...
		try {
			...
			scanner.close();
			UnicastRemoteObject.unexportObject(courseService, true);
		} catch (Exception e) {
