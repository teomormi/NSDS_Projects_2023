...
public class ProjectService extends UnicastRemoteObject implements ProjectRemote {
	...
	private static final KafkaProducer<String, String> project_producer = KafkaBroker.getProducerTransactional();
	...
	public static void main(String[] args) {
		try {
			System.out.println("CURRENT ADDRESS " + InetAddress.getLocalHost().getHostAddress() + ":" + projectServicePort);
	...
	/*** STUDENT DASHBOARD ***/
	@Override
	public boolean addSubmission(String course_name, String project_name, String username, String file_path) throws
			RemoteException {
		// in this case the submission in only the file path
