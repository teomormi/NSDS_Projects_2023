...
public class ServerHTTP {
	// must be equal to utils configuration
	private static final String httpAddress = "127.0.0.1";
	...
	/*** Implement HTTP Handler in 2 ways:
	 ...
	 - same handler but with "type" parameter in the request, faster to implement  ***/
